...
void EndScene::Load()
{
	string optionsText[3] = { "Congratulations!", "Player is now out of Void and reunited with their dog!", "Press Space to go back to Main Menu" };
	for (int i = 0; i < 3; ++i) {
...
{
	if (Keyboard::isKeyPressed(Controls::Continue) || sf::Joystick::isButtonPressed(0, 6)) {
